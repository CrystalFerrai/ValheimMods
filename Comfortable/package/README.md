Adds configuration options to modify details related to the comfort system.
* Range of comfort objects
* Range of fire warmth
* Rested buff base time and time per comfort level
